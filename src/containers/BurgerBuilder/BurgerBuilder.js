...
const BurgerBuilder = (props) => {
	...
	const ings = useSelector((state) => state.burgerBuilder.ingredient);
	...
	const onInitIngredients = useCallback(
		() => dispatch(burgerBuilderActions.initIngredients()),[dispatch]
	);
...
// This is use connect react-redux
